                ...
                <div class="card text-left">
                    <div class="card-body">
                        <div class="jumbotron jumbotron-fluid">
                            <div class="container">
                                <h1 class="display-4"><i class="nav-icon fas fa-folder"></i><b> Archivos</b></h1>
                ...
                "columnDefs": [
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            var btn_historial_paciente ="<a href='{{url('/')}}/archivos/paciente/"+row.id+"' id='btn_historial_paciente' class='btn btn-sm btn-success' title='Historial Clinico' ><i class='fas fa-folder-open'></i> Ver Archivos</a>";
