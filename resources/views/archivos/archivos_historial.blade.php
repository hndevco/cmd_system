                ...
                <div class="card text-left">
                    <div class="card-body">
                        <div class="jumbotron jumbotron-fluid">
                            <div class="container">
                                <h1 class="display-4"><i class="nav-icon fas fa-folder-open"></i><b> Archivos del Paciente</b></h1>
                        ...
                        </div><a href="{{url('/archivos-pacientes')}}/" type="button" class="btn btn-sm btn-success"><i class="nav-icon fas fa-hospital-user"></i> Regresar a Listado de Pacientes</a>
                    </div>
                </div>
                ...
                <div class="card-body">                    
                    ...
                    <div class="tab-content" id="custom-content-above-tabContent">
                        <div class="tab-pane fade show active" id="custom-content-above-home" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                            @if($arc_leer_archivos_historial_clinico_digital == 1)
                            <div class="card-body table-responsive">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="tbl_historial_clinico" class="table table-hover dataTable dtr-inline">
                            ...
                            <section class="content">
                                <div class="error-page">
                                    ...
                                    <div class="error-content">
                                        <h3><i class="fas fa-exclamation-triangle text-warning"></i> Oops! Acceso Denegado.</h3>
                                        <p>
                                            Necesita un permiso adecuado para ingresar a este apartado.
                                        </p>
                                    </div>
                                </div>
                            </section>
                        ...
                        <div class="tab-pane fade" id="custom-content-above-profile" role="tabpanel" aria-labelledby="custom-content-above-profile-tab">
                            <div class="tab-pane fade show active" id="custom-content-above-home" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                                @if($arc_leer_archivos_historial_clinico_fisico == 1)
                                <div class="card-body table-responsive">
                                    <div class="row">
                ...
                "columnDefs": [
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            if(arc_leer_otros_archivos){
                                btn_otros_archivos= "<a target='_blank' href='{{url('/')}}/archivos/paciente/"+row.id_paciente+"/remision/"+row.id+"/expediente/"+row.id_area+"' class='btn btn-sm btn-info' title='Ver Otros Archivos'><i class='fas fa-copy'></i> Otros Archivos</a>";
                            }
                            return btn_ver_examenes + btn_otros_archivos ;
                        }
                    }
                ]
