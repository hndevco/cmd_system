                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <select class="custom-select" id="input_indice_masa_corporal" @if($estado_edicion->estado_edicion == 1) @else disabled @endif>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" value="{{$ginecologia->gestas}}" @if($estado_edicion->estado_edicion == 1) @else disabled @endif class="form-control" placeholder="C°" id="input_gestas" aria-label="Username" aria-describedby="basic-addon1" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" value="{{$ginecologia->partos}}" @if($estado_edicion->estado_edicion == 1) @else disabled @endif class="form-control" id="input_partos" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" value="{{$ginecologia->cesareas}}" @if($estado_edicion->estado_edicion == 1) @else disabled @endif class="form-control" id="input_cesareas" placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" value="{{$ginecologia->hijos_vivos}}" @if($estado_edicion->estado_edicion == 1) @else disabled @endif class="form-control" id="input_hijos_vivos" placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" value="{{$ginecologia->hijos_muertos}}" @if($estado_edicion->estado_edicion == 1) @else disabled @endif class="form-control" id="input_hijos_muertos" placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="date" value="{{$ginecologia->fecha_parto}}" @if($estado_edicion->estado_edicion == 1) @else disabled @endif class="form-control" id="input_fecha_ultimo_parto" placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" value="{{$ginecologia->atendido}}" @if($estado_edicion->estado_edicion == 1) @else disabled @endif class="form-control" id="input_atendido" placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">FUM 
                                                @if($estado_edicion->estado_edicion == 1)
                                                    &nbsp;&nbsp;<input type="radio" name="fum_radio" id="fum_radio" onclick="fum_radio(1)" @if($ginecologia->fecha_ultima_mestruacion == null || $ginecologia->fecha_ultima_mestruacion == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                    &nbsp;&nbsp;<input type="radio" name="fum_radio" id="fum_radio" onclick="fum_radio(2)" @if($ginecologia->fecha_ultima_mestruacion == null || $ginecologia->fecha_ultima_mestruacion == '') checked @else @endif aria-label="Radio button for following text input"> No Aplica
                                                    &nbsp;&nbsp;<input type="radio" name="fum_radio" id="fum_radio" onclick="fum_radio(3)" @if($ginecologia->fum_desconoce == null || $ginecologia->fum_desconoce == '') @else checked @endif aria-label="Radio button for following text input"> Desconoce
                                                @endif
                                            </span>
                                        </div>
                                        <input type="date" value="{{$ginecologia->fecha_ultima_mestruacion}}" @if($estado_edicion->estado_edicion == 1 && ($ginecologia->fecha_ultima_mestruacion != null || $ginecologia->fecha_ultima_mestruacion != '')) @else disabled @endif class="form-control" id="input_fum" placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">FPP 
                                                @if($estado_edicion->estado_edicion == 1)
                                                    &nbsp;&nbsp;<input type="radio" name="fpp_radio" id="fpp_radio" onclick="fpp_radio(1)" @if($ginecologia->fecha_provable_parto == null || $ginecologia->fecha_provable_parto == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                    &nbsp;&nbsp;<input type="radio" name="fpp_radio" id="fpp_radio" onclick="fpp_radio(0)" @if($ginecologia->fecha_provable_parto == null || $ginecologia->fecha_provable_parto == '') checked @else @endif aria-label="Radio button for following text input"> No Aplica
                                                @endif
                                            </span>
                                        </div>
                                        <input type="date" value="{{$ginecologia->fecha_provable_parto}}" @if($estado_edicion->estado_edicion == 1 && ($ginecologia->fecha_provable_parto != null || $ginecologia->fecha_provable_parto != '')) @else disabled @endif class="form-control" id="input_fpp"  placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" value="{{$ginecologia->citologia}}" @if($estado_edicion->estado_edicion == 1) @else disabled @endif class="form-control" id="input_citologia" placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">PLANIFICACIÓN FAMILIAR (PF) 
                                                @if($estado_edicion->estado_edicion == 1)
                                                    &nbsp;&nbsp;<input type="radio" name="pf_radio" id="pf_radio" onclick="pf_radio(1)" @if($ginecologia->descripcion_planificacion_familiar == null || $ginecologia->descripcion_planificacion_familiar == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                    &nbsp;&nbsp;<input type="radio" name="pf_radio" id="pf_radio" onclick="pf_radio(0)" @if($ginecologia->descripcion_planificacion_familiar == null || $ginecologia->descripcion_planificacion_familiar == '') checked @else @endif aria-label="Radio button for following text input"> No
                                                @endif
                                            </span>
                                        </div>
                                        <input type="text" value="{{$ginecologia->descripcion_planificacion_familiar}}" @if($estado_edicion->estado_edicion == 1 && ($ginecologia->descripcion_planificacion_familiar != null || $ginecologia->descripcion_planificacion_familiar != '')) @else disabled @endif class="form-control" id="input_pf" placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4"> 
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">VAGINOSIS 
                                                @if($estado_edicion->estado_edicion == 1)
                                                &nbsp;&nbsp;<input type="radio" name="vaginosis_radio" id="vaginosis_radio" onclick="vaginosis_radio(1)" @if($ginecologia->descripcion_vaginosis == null || $ginecologia->descripcion_vaginosis == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                &nbsp;&nbsp;<input type="radio" name="vaginosis_radio" id="vaginosis_radio" onclick="vaginosis_radio(0)" @if($ginecologia->descripcion_vaginosis == null || $ginecologia->descripcion_vaginosis == '') checked @else @endif aria-label="Radio button for following text input"> No
                                                @endif
                                            </span>
                                        </div>
                                        <input type="text" value="{{$ginecologia->descripcion_vaginosis}}" @if($estado_edicion->estado_edicion == 1 && ($ginecologia->descripcion_vaginosis != null || $ginecologia->descripcion_vaginosis != '')) @else disabled @endif class="form-control" id="input_vaginosis" placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">INFECCIÓN DEL TRACTO URINARIO (ITU) 
                                                @if($estado_edicion->estado_edicion == 1)
                                                &nbsp;&nbsp;<input type="radio" name="itu_radio" id="itu_radio" onclick="itu_radio(1)" @if($ginecologia->descripcion_infeccion_tracto_urinario == null || $ginecologia->descripcion_infeccion_tracto_urinario == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                &nbsp;&nbsp;<input type="radio" name="itu_radio" id="itu_radio" onclick="itu_radio(0)" @if($ginecologia->descripcion_infeccion_tracto_urinario == null || $ginecologia->descripcion_infeccion_tracto_urinario == '') checked @else @endif aria-label="Radio button for following text input"> No
                                                @endif
                                            </span>
                                        </div>
                                        <input type="text" value="{{$ginecologia->descripcion_infeccion_tracto_urinario}}" @if($estado_edicion->estado_edicion == 1 && ($ginecologia->descripcion_infeccion_tracto_urinario != null || $ginecologia->descripcion_infeccion_tracto_urinario != '')) @else disabled @endif class="form-control" id="input_itu" placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">PRURITO 
                                                @if($estado_edicion->estado_edicion == 1)
                                                &nbsp;&nbsp;<input type="radio" name="prurito_radio" id="prurito_radio" onclick="prurito_radio(1)" @if($ginecologia->descripcion_prurito == null || $ginecologia->descripcion_prurito == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                &nbsp;&nbsp;<input type="radio" name="prurito_radio" id="prurito_radio" onclick="prurito_radio(0)" @if($ginecologia->descripcion_prurito == null || $ginecologia->descripcion_prurito == '') checked @else @endif aria-label="Radio button for following text input"> No
                                                @endif
                                            </span>
                                        </div>
                                        <input type="text" value="{{$ginecologia->descripcion_prurito}}" @if($estado_edicion->estado_edicion == 1 && ($ginecologia->descripcion_prurito != null || $ginecologia->descripcion_prurito != '')) @else disabled @endif class="form-control" id="input_prurito" placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">MENARQUIA 
                                                @if($estado_edicion->estado_edicion == 1)
                                                &nbsp;&nbsp;<input type="radio" name="menarquia_radio" id="menarquia_radio" onclick="menarquia_radio(1)" @if($ginecologia->descripcion_menarquia == null || $ginecologia->descripcion_menarquia == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                &nbsp;&nbsp;<input type="radio" name="menarquia_radio" id="menarquia_radio" onclick="menarquia_radio(0)" @if($ginecologia->descripcion_menarquia == null || $ginecologia->descripcion_menarquia == '') checked @else @endif aria-label="Radio button for following text input"> No
                                                @endif
                                            </span>
                                        </div>
                                        <input type="text" value="{{$ginecologia->descripcion_menarquia}}" @if($estado_edicion->estado_edicion == 1 && ($ginecologia->descripcion_menarquia != null || $ginecologia->descripcion_menarquia != '')) @else disabled @endif class="form-control" id="input_menarquia" placeholder="kg" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">INICIO DE VIDA SEXUAL (IVS) 
                                                @if($estado_edicion->estado_edicion == 1)
                                                &nbsp;&nbsp;<input type="radio" name="ivs_radio" id="ivs_radio" onclick="ivs_radio(1)" @if($ginecologia->edad_inicio_vida_sexual == null || $ginecologia->edad_inicio_vida_sexual == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                &nbsp;&nbsp;<input type="radio" name="ivs_radio" id="ivs_radio" onclick="ivs_radio(0)" @if($ginecologia->edad_inicio_vida_sexual == null || $ginecologia->edad_inicio_vida_sexual == '') checked @else @endif aria-label="Radio button for following text input"> No
                                                @endif
                                            </span>
                                        </div>
                                        <input type="number" value="{{$ginecologia->edad_inicio_vida_sexual}}" @if($estado_edicion->estado_edicion == 1&& ($ginecologia->edad_inicio_vida_sexual != null || $ginecologia->edad_inicio_vida_sexual != '')) @else disabled @endif class="form-control" id="input_ivs" placeholder="Años" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" value="{{$ginecologia->numero_parejas_sexuales}}" @if($estado_edicion->estado_edicion == 1) @else disabled @endif class="form-control" id="input_numero_parejas_sexuales" placeholder="Años" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header bg-info">
                                        <h5 class="card-title">
                                            ...
                                            @if($estado_edicion->estado_edicion == 1)
                                            &nbsp;&nbsp;<input type="radio" name="ets_radio" id="ets_radio" onclick="ets_radio(1)" @if($ginecologia->tipo_enfermedades_trasmision_sexual == null || $ginecologia->tipo_enfermedades_trasmision_sexual == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                            &nbsp;&nbsp;<input type="radio" name="ets_radio" id="ets_radio" onclick="ets_radio(0)" @if($ginecologia->tipo_enfermedades_trasmision_sexual == null || $ginecologia->tipo_enfermedades_trasmision_sexual == '') checked @else @endif aria-label="Radio button for following text input"> No
                                            @endif
                                        </h5>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" value="{{$ginecologia->vida_sexual_activa}}" @if($estado_edicion->estado_edicion == 1) @else disabled @endif class="form-control" id="input_vida_sexual_activa" placeholder="Años" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">ANTECEDENTES PERSONALES PATOLOGICOS (APP)
                                                @if($estado_edicion->estado_edicion == 1)
                                                &nbsp;&nbsp;<input type="radio" name="app_radio" id="app_radio" onclick="app_radio(1)" @if($ginecologia->tipo_antecendestes_personales_patologicos == null || $ginecologia->tipo_antecendestes_personales_patologicos == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                &nbsp;&nbsp;<input type="radio" name="app_radio" id="app_radio" onclick="app_radio(0)" @if($ginecologia->tipo_antecendestes_personales_patologicos == null || $ginecologia->tipo_antecendestes_personales_patologicos == '') checked @else @endif aria-label="Radio button for following text input"> No
                                                @endif
                                            </span>
                                        </div>
                                        <input type="text" value="{{$ginecologia->tipo_antecendestes_personales_patologicos}}" @if($estado_edicion->estado_edicion == 1 && ($ginecologia->tipo_antecendestes_personales_patologicos != null || $ginecologia->tipo_antecendestes_personales_patologicos != '')) @else disabled @endif class="form-control" id="input_app" placeholder="Años" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">AFP
                                                @if($estado_edicion->estado_edicion == 1)
                                                &nbsp;&nbsp;<input type="radio" name="afp_radio" id="afp_radio" onclick="afp_radio(1)" @if($ginecologia->afp == null || $ginecologia->afp == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                &nbsp;&nbsp;<input type="radio" name="afp_radio" id="afp_radio" onclick="afp_radio(0)" @if($ginecologia->afp == null || $ginecologia->afp == '') checked @else @endif aria-label="Radio button for following text input"> No
                                                @endif
                                            </span>
                                        </div>
                                        <input type="text" value="{{$ginecologia->afp}}" @if($estado_edicion->estado_edicion == 1 && ($ginecologia->afp != null || $ginecologia->afp != '')) @else disabled @endif class="form-control" id="input_afp" placeholder="Años" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">ANTECEDENTES INMUNOALERGICOS (AIA)
                                                @if($estado_edicion->estado_edicion == 1)
                                                &nbsp;&nbsp;<input type="radio" name="aia_radio" id="aia_radio" onclick="aia_radio(1)" @if($ginecologia->tipo_antecedentes_inmunoalergicos == null || $ginecologia->tipo_antecedentes_inmunoalergicos == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                &nbsp;&nbsp;<input type="radio" name="aia_radio" id="aia_radio" onclick="aia_radio(0)" @if($ginecologia->tipo_antecedentes_inmunoalergicos == null || $ginecologia->tipo_antecedentes_inmunoalergicos == '') checked @else @endif aria-label="Radio button for following text input"> No
                                                @endif
                                            </span>
                                        </div>
                                        <input type="text" value="{{$ginecologia->tipo_antecedentes_inmunoalergicos}}" @if($estado_edicion->estado_edicion == 1 && ($ginecologia->tipo_antecedentes_inmunoalergicos != null || $ginecologia->tipo_antecedentes_inmunoalergicos != '')) @else disabled @endif class="form-control" id="input_aia" placeholder="Años" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">HABITOS
                                                @if($estado_edicion->estado_edicion == 1)
                                                &nbsp;&nbsp;<input type="radio" name="habitos_radio" id="habitos_radio" onclick="habitos_radio(1)" @if($ginecologia->habitos == null || $ginecologia->habitos == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                &nbsp;&nbsp;<input type="radio" name="habitos_radio" id="habitos_radio" onclick="habitos_radio(0)" @if($ginecologia->habitos == null || $ginecologia->habitos == '') checked @else @endif aria-label="Radio button for following text input"> No
                                                @endif
                                            </span>
                                        </div>
                                        <input type="text" value="{{$ginecologia->habitos}}" @if($estado_edicion->estado_edicion == 1 && ($ginecologia->habitos != null || $ginecologia->habitos != '')) @else disabled @endif class="form-control" id="input_habitos"  placeholder="Años" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">ANTECEDENTES HOSPITALARIOS Y QUIRURGICOS (AHxTxQx)
                                                @if($estado_edicion->estado_edicion == 1)
                                                &nbsp;&nbsp;<input type="radio" name="AHxTxQx_radio" id="AHxTxQx_radio" onclick="AHxTxQx_radio(1)" @if($ginecologia->tipos_antecedentes_hospitalarios_quirurgicos == null || $ginecologia->tipos_antecedentes_hospitalarios_quirurgicos == '') @else checked @endif aria-label="Radio button for following text input"> Si
                                                &nbsp;&nbsp;<input type="radio" name="AHxTxQx_radio" id="AHxTxQx_radio" onclick="AHxTxQx_radio(0)" @if($ginecologia->tipos_antecedentes_hospitalarios_quirurgicos == null || $ginecologia->tipos_antecedentes_hospitalarios_quirurgicos == '') checked @else @endif aria-label="Radio button for following text input"> No
                                                @endif
                                            </span>
                                        </div>
                                        <input type="text" value="{{$ginecologia->tipos_antecedentes_hospitalarios_quirurgicos}}" @if($estado_edicion->estado_edicion == 1 && ($ginecologia->tipos_antecedentes_hospitalarios_quirurgicos != null || $ginecologia->tipos_antecedentes_hospitalarios_quirurgicos != '')) @else disabled @endif class="form-control" id="input_AHxTxQx" placeholder="Años" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header bg-info">
                                        <h5 class="card-title">
                                            ...
                                            @if($estado_edicion->estado_edicion == 1)
                                            &nbsp;&nbsp;<input type="radio" name="mc_radio" id="mc_radio" onclick="mc_radio(1)" @if($ginecologia_mc_hea->motivo_cosulta == null || $ginecologia_mc_hea->motivo_cosulta == '') @else checked @endif aria-label="Radio button for following text input"> Ginecología
                                            &nbsp;&nbsp;<input type="radio" name="mc_radio" id="mc_radio" onclick="mc_radio(0)" @if($ginecologia_mc_hea->motivo_cosulta == null || $ginecologia_mc_hea->motivo_cosulta == '') checked @else @endif aria-label="Radio button for following text input"> Obstétrica
                                            @endif
                                        </h5>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" value="{{$ginecologia_mc_hea->historia_enfermedad_actual}}" @if($estado_edicion->estado_edicion == 1) @else disabled @endif class="form-control" id="input_historia_enfermedad_actual" placeholder="Años" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="date" value="{{$examen_fisico->proxima_cita}}" @if($estado_edicion->estado_edicion == 1) @else disabled @endif class="form-control" id="input_proxima_cita" placeholder="C°" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function guardar_expediente() {
        ...
        $.ajax({
            ...
            data: {
                "accion": accion,
                "estado_edicion_subsiguiente": estado_edicion_subsiguiente,
                //inicia sigons vitales
