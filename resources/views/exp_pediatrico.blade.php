            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <h5>
                            Médico: 
                                <small class="text-muted"><ins>{{$medico->nombre}}</ins></small>
                        </h5>
                    </div>
                </div>
                <hr>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div id="div_input_mc_ginecologia">
                                            <textarea class="form-control" id="input_mc" rows="3" placeholder="Ingrese el motivo de la consulta"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div id="div_input_mc_ginecologia">
                                            <textarea class="form-control" id="input_historia_enfermedad_actual" rows="3" placeholder="Ingrese la historia de la enfermedad actual"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" class="form-control" id="input_afp" placeholder="Describa aquí" aria-label="Username" aria-describedby="basic-addon1"
                                       value="{{$consulta->antecedentes_familiares_patologicos}}"
                                        >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" class="form-control" id="input_AHxTxQx" placeholder="Describa aquí" aria-label="Username" aria-describedby="basic-addon1"
                                        value="{{$consulta->antecedentes_hospitalarios_quirurgicos}}"
                                        >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" class="form-control" id="input_inmunizacion" placeholder="Describa aquí" aria-label="Username" aria-describedby="basic-addon1"
                                        value="{{$consulta->inmunizacion}}"
                                        >
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-header bg-info">
                                        <h5 class="card-title">
                                            ...
                                            &nbsp;&nbsp;<input type="radio" name="alergias_radio" id="alergias_radio" onclick="alergias_radio(1)" checked aria-label="Radio button for following text input"> Si
                                            &nbsp;&nbsp;<input type="radio" name="alergias_radio" id="alergias_radio" onclick="alergias_radio(0)" aria-label="Radio button for following text input"> No
                                          
                                        </h5>
                                    </div>
                                    <div class="card-body">
                                        <textarea class="form-control" id="input_alergias" rows="3" placeholder="Describa aquí"
                                        >{{$consulta->tipo_alergia}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1">NOMBRE MADRE</span>
                                        </div>
                                        <input type="text" class="form-control" id="input_nombre_madre" placeholder="Nombre de la madre" aria-label="Username" aria-describedby="basic-addon1"
                                     value="{{$antecendentes_prenatales->nombre_madre}}"
                                        >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" class="form-control" id="input_edad_madre" placeholder="Edad de la madre" aria-label="Username" aria-describedby="basic-addon1"
                                        value="{{$antecendentes_prenatales->edad}}"
                                        >
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-header bg-info">
                                        <h5 class="card-title">
                                            ...
                                            &nbsp;&nbsp;<input type="radio" name="enfer_durante_embarazo_radio" id="enfer_durante_embarazo_radio" onclick="enfer_durante_embarazo_radio(1)" checked aria-label="Radio button for following text input"> Si
                                            &nbsp;&nbsp;<input type="radio" name="enfer_durante_embarazo_radio" id="enfer_durante_embarazo_radio" onclick="enfer_durante_embarazo_radio(0)" aria-label="Radio button for following text input"> No
                                          
                                        </h5>
                                    </div>
                                    <div class="card-body">
                                        <textarea class="form-control" id="input_enfer_durante_embarazo" rows="3" placeholder="Describa las enfermedades"
                                        >{{$antecendentes_prenatales->enfermedades_durante_embarazo}}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" class="form-control" id="input_numero_gestas_previas" placeholder="¿Cuántas gestas previas?" aria-label="Username" aria-describedby="basic-addon1"
                                      value="{{$antecendentes_prenatales->gestas}}"
                                        >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" class="form-control" id="input_numero_partos" placeholder="¿Cuántos partos?" aria-label="Username" aria-describedby="basic-addon1"
                                        value="{{$antecendentes_prenatales->partos}}"
                                        >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" class="form-control" id="input_numero_cesareas" placeholder="¿Cuántas cesáreas?" aria-label="Username" aria-describedby="basic-addon1"
                                        value="{{$antecendentes_prenatales->cesarias}}"
                                        >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" class="form-control" id="input_numero_control_prenatal_utlimo_parto" placeholder="¿Cuántas controles?" aria-label="Username" aria-describedby="basic-addon1"
                                        value="{{$antecendentes_prenatales->control_prenatal_ultimo_embarazo}}"
                                        >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" class="form-control" id="input_nace_en" placeholder="¿Dónde nació el bebé?" aria-label="Username" aria-describedby="basic-addon1"
                                        value="{{$natalicio->lugar_nacimiento}}"
                                        >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" class="form-control" id="input_apgar" placeholder="Datos" aria-label="Username" aria-describedby="basic-addon1"
                                       value="{{$natalicio->apgar}}"
                                        >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" class="form-control" id="input_peso_natalicio" placeholder="g" aria-label="Username" aria-describedby="basic-addon1"
                                        value="{{$natalicio->peso}}"
                                        >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" class="form-control" id="input_talla_natalicio" placeholder="cm" aria-label="Username" aria-describedby="basic-addon1"
                                        value="{{$natalicio->talla}}"
                                        >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number" class="form-control" id="input_perimetro_cefalico" placeholder="cm" aria-label="Username" aria-describedby="basic-addon1"
                                        value="{{$natalicio->perimetro_cefalico}}"
                                        >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <select class="custom-select" id="input_tipo_parto"
                                            >
                                            <option selected disabled>Elija una opcion</option>
                                ...
                                <div class="card">
                                    <div class="card-header bg-info">
                                        <h5 class="card-title">
                                            ...
                                            &nbsp;&nbsp;<input type="radio" name="complicaciones_parto_radio" id="complicaciones_parto_radio" onclick="complicaciones_parto_radio(1)" checked aria-label="Radio button for following text input"> Si
                                            &nbsp;&nbsp;<input type="radio" name="complicaciones_parto_radio" id="complicaciones_parto_radio" onclick="complicaciones_parto_radio(0)" aria-label="Radio button for following text input"> No
                                            
                                        </h5>
                                    </div>
                                    <div class="card-body">
                                        <textarea class="form-control" id="input_complicaciones_parto" rows="3" placeholder="¿Qué complicaciones presentó?"
                                        >{{$natalicio->complicaciones_parto}}</textarea>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group clearfix">
                                                <div class="icheck-primary d-outline">
                                                    <input type="checkbox" id="checkboxSonrio"
                                                    @if($desarrollo_psicomotor->sonrio == 1) checked
                                                    @endif>
                                                ...
                                                <div class="icheck-primary d-outline">
                                                    <input type="checkbox" id="checkboxSostuvoCabeza"
                                                    @if($desarrollo_psicomotor->sostuvo_cabeza == 1) checked
                                                    @endif>
                                                ...
                                                <div class="icheck-primary d-outline">
                                                    <input type="checkbox" id="checkboxSeSento"
                                                    @if($desarrollo_psicomotor->se_sento == 1) checked
                                                    @endif>
                                                ...
                                                <div class="icheck-primary d-outline">
                                                    <input type="checkbox" id="checkboxSeParo"
                                                    @if($desarrollo_psicomotor->se_paro == 1) checked
                                                    @endif>
                                                ...
                                                <div class="icheck-primary d-outline">
                                                    <input type="checkbox" id="checkboxCaminoSolo"
                                                    @if($desarrollo_psicomotor->comino_solo == 1) checked
                                                    @endif>
                                                ...
                                                <div class="icheck-primary d-outline">
                                                    <input type="checkbox" id="checkboxHabla"
                                                    @if($desarrollo_psicomotor->habla == 1) checked
                                                    @endif>
                                                ...
                                                <div class="icheck-primary d-outline">
                                                    <input type="checkbox" id="checkboxControlEsfinteres"
                                                    @if($desarrollo_psicomotor->control_esfinteres == 1) checked
                                                    @endif>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header bg-info">
                                                <h5 class="card-title">
                                                    ESCOLARIDAD ACTUAL
                                                    &nbsp;&nbsp;<input type="radio" name="escolaridad_acual_radio" id="escolaridad_acual_radio" onclick="escolaridad_acual_radio(1)" checked aria-label="Radio button for following text input"> Si
                                                    &nbsp;&nbsp;<input type="radio" name="escolaridad_acual_radio" id="escolaridad_acual_radio" onclick="escolaridad_acual_radio(0)" aria-label="Radio button for following text input"> No
                                                   
                                                </h5>
                                            </div>
                                            <div class="card-body">
                                                <textarea class="form-control" id="input_escolaridad_actual" rows="3" placeholder="¿Cual escolaridad?"
                                                >{{$desarrollo_psicomotor->escolaridad_actual}}</textarea>
                        ...
                        <div class="card card-default">
                            <div class="card-header bg-primary">
                                <h3 class="card-title">LACTANCIA
                                    &nbsp;&nbsp;<input type="radio" name="lactancia_radio" id="lactancia_radio" onclick="lactancia_radio(1)" checked aria-label="Radio button for following text input"> Si
                                    &nbsp;&nbsp;<input type="radio" name="lactancia_radio" id="lactancia_radio" onclick="lactancia_radio(0)" aria-label="Radio button for following text input"> No
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="icheck-primary">
                                                            <input type="radio" id="checkboxMaterna" name="lactancia" 
                                                            @if($lactancia->lactancia_materna == 1 && $lactancia->lactancia_artificial == 0) checked
                                                            @endif>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="icheck-primary text-center pull center">
                                                            <input type="radio" id="checkboxArtificial" name="lactancia"
                                                            @if($lactancia->lactancia_materna == 0 && $lactancia->lactancia_artificial == 1) checked
                                                            @endif>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="icheck-primary  text-right pull right">
                                                            <input type="radio" id="checkboxMixta" name="lactancia"
                                                            @if($lactancia->lactancia_materna == 1 && $lactancia->lactancia_artificial == 1) checked
                                                            @endif>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <textarea class="form-control" id="input_ablactacion" rows="3" placeholder="Describa la primera comida"
                                               >{{$lactancia->ablactacion}}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <textarea class="form-control" id="input_alimentacion_actual" rows="3" placeholder="Describa la alimentación actual"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body" style="display: block;">
                        <div class="row">
                            <div class="col-md-12">
                                <textarea class="form-control" id="input_examen_fisico" rows="3" placeholder="Describa el examen físico"></textarea>     
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card card-default">
                    ...
                    <div class="card-body" style="display: block;">
                        <div class="row">
                            <div class="col-md-12">
                                <textarea class="form-control" id="input_diagnostico" rows="3" placeholder="Escriba el diagnóstico"></textarea>     
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card card-default">
                    ...
                    <div class="card-body" style="display: block;">
                        <div class="row">
                            <div class="col-md-12">
                                <textarea class="form-control" id="input_indicaciones" rows="3" placeholder="Esciba las indicaciones"></textarea>     
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-8 col-sm-8">
                                <center>
                                    ...
                                    <ul class="list-unstyled">
                                        <li><h4><strong>Dr (a). {{$medico->nombre}}</strong></h4></li>
                                        <li>{{$medico->cargo}}</li>
                                        <li>Cel.: {{$medico->celular}}</h2>
                                    </ul>
                                </center> 
                            </div>
                            <div class="col-md-2 col-sm-2">
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.msgError != null) {
                    ...
                    typeMsg = "error";
                    $('#btn_guardar_expediente').attr('disabled', false);
                    $('#btn_enviar_observacion').attr('disabled', false);
                } else {
